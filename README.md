...
In this project, you can use deep neural networks and convolutional neural networks to clone driving behavior. You should train, validate and test a model using Keras. The model will output a steering angle to an autonomous vehicle.
...
I also have created a detailed writeup of my implementation of the project. Check out the [writeup report](./writeup_report.md) for this project.
...
Usage of `drive.py` requires you have saved the trained model as an h5 file, i.e. `model.h5`. See the [Keras documentation](https://keras.io/getting-started/faq/#how-can-i-save-a-keras-model) for how to create this file using the following command, or load the pretrained model that is in this folder:
```sh
model.save(filepath)
```
